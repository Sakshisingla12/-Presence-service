            ...
            <div class="tab-pane active" id="home">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="password" id="inputPassword" class="form-control" placeholder="Password" name="password" title="enter your password." required>
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="password2"><h4>Verify Password</h4></label>
                              <input type="password" id="inputPassword2" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control" placeholder="Password2" name="password2" title="enter your password Again." required>
                          </div>
                      </div>
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                <br>
                                <center><button class="btn btn-lg btn-success" type="submit" value="signup" name="submit"><i class="glyphicon glyphicon-ok-sign" ></i> Save</button>
